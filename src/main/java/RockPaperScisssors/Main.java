...
import RockPaperScisssors.Game2.Tech2;
...
public class Main {
    ...
    private static void game1(){
        ...
        System.out.println("Running Technique 1 - Thread Pool");
        ...
        System.out.println("\nRunning Technique 2 - Parallel Streams");
    ...
    private static void game2(){
        ...
        System.out.print("Enter number of players: ");
        int numPlayer = new Scanner(System.in).nextInt();
        System.out.println("Running Technique 1 - Single Thread");
        long sTime = System.currentTimeMillis();
        new RockPaperScisssors.Game2.Tech1(numPlayer);

        System.out.println("Technique took "+(System.currentTimeMillis()-sTime)+"ms");

        System.out.println("\nRunning Technique 2 - Thread Pool");
        sTime = System.currentTimeMillis();
        new Tech2(numPlayer,Runtime.getRuntime().availableProcessors());
        System.out.println("Technique took "+(System.currentTimeMillis()-sTime)+"ms");
    }
}
